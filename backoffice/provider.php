                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              ...
                              <a href="<?php echo $urlweb; ?>/function/del-provider.php?postID=<?php echo $s1['id']; ?>&status=<?php echo $s1['status']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah kamu yakin ingin menghapus data?');"><i class="fa fa-trash"></i></a>
                            </td>
                          </tr>
                          <?php } ?> 
                        </tbody>
