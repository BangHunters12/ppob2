        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Produk /</span> Produk Social Media</h4>
              <?php
                error_reporting(0);
                if(isset($_GET['do'])){
                  if (!empty($_GET['notif'])) {
                    if ($_GET['notif'] == 1) {
                      echo '
                        <div class="alert alert-success d-flex align-items-center" role="alert">
                          ...
                          <span><strong>Well Done!</strong> Produk Social Media Tersimpan!</span>
                        </div>
                      ';
                    }
                  }
